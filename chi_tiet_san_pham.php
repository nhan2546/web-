...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const mainImageEls = document.querySelectorAll('.product-main-image'); // Select all main images
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function resetReplyState() {
        ...
        // Bỏ yêu cầu cho rating
        document.querySelectorAll('input[name="rating"]').forEach(r => r.required = false);
        document.querySelector('input[name="rating"]:checked')?.setAttribute('required', 'required');
    }
    ...
    document.querySelectorAll('.reply-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Ẩn đánh giá sao và ảnh khi trả lời
            starRatingGroup.style.display = 'none';
            // Bỏ yêu cầu cho rating khi trả lời
            document.querySelectorAll('input[name="rating"]').forEach(r => r.required = false);
    ...
    const variantPrices = {
        "128GB": {
            "Titan tự nhiên": basePrice,
            "Titan xanh": basePrice + 500000,
            "Titan trắng": basePrice + 500000,
        },
        "256GB": {
            "Titan tự nhiên": basePrice + 2000000,
            "Titan xanh": basePrice + 2500000,
            "Titan trắng": basePrice + 2500000,
        },
        "512GB": {
            "Titan tự nhiên": basePrice + 5000000,
            "Titan xanh": basePrice + 5500000,
            "Titan trắng": basePrice + 5500000,
        }
    };
